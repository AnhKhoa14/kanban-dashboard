<template>
  <div class="flex flex-col gap-3">
    <v-card elevation="0" v-for="card in completedCards" :key="card.title" rounded="xl"
      class="flex flex-col border border-[#E2E8F0] shadow-[#1717171A] gap-3">
      <v-card-subtitle :class="[
        'rounded-full w-fit mt-3 ml-3 h-6 text-[11px] font-bold px-3 d-md-flex items-center justify-center',
...
const completedCards = cardData.filter(card => card.status === 'completed');
