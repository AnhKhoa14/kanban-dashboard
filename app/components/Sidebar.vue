<template>
  <!-- <client-only> -->
    <v-navigation-drawer permanent elevation="0" class="border-e" :width="280">
      <div class="pa-4">
      ...
      <v-list density="compact" nav>
        <div class="flex justify-between">
          ...
          <span
            class="flex justify-center items-center border border-[#A5B4FC] gap-1.5 px-3 rounded-full w-fit">10</span>
        </div>
        ...
        <div class="flex justify-between">
          ...
          <span
            class="flex justify-center items-center border border-[#A5B4FC] gap-1.5 px-3 rounded-full w-fit">2</span>
        </div>
        ...
        <div class="pa-4 border-t">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
              ...
              <div>
                <div class="text-sm font-bold">Azunyan U. Wu</div>
                <div class="text-xs text-gray-500">Basic Member</div>
              </div>
            </div>
            <v-icon icon="mdi-logout" color="gray"></v-icon>
          </div>
        </div>
      </template>
    </v-navigation-drawer>
